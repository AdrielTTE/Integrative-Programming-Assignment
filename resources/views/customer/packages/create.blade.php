...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <form action="{{ route('customer.payment.createAndPay') }}" method="POST" id="createPackageForm">
            @csrf
            ...
            <div class="mt-6 p-4 bg-gray-50 rounded-lg">
                ...
                <small class="text-gray-500">Package will be created only after successful payment</small>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // FIXED cost calculation to match Package model
    function updateCostEstimation() {
        const weight = parseFloat(weightInput.value) || 0;
        const priority = prioritySelect.value;
        
        if (weight > 0) {
            let baseCost = 10.00; // Match Package model
            let weightCost = weight * 2.5; // Match Package model  
