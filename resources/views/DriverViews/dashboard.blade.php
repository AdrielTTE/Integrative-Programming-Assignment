            ...
            <div class="flex justify-between items-center">
                ...
                <div>
                    <form action="{{ route('driver.dashboard.update-status') }}" method="POST">
                        ...
                        @if($driver->driver_status === 'AVAILABLE')
                            <button type="submit" class="px-5 py-2 bg-red-500 text-white font-semibold rounded-md hover:bg-red-600 shadow-sm">
                                Set Status to BUSY
                            </button>
                        @else
                            <button type="submit" class="px-5 py-2 bg-green-500 text-white font-semibold rounded-md hover:bg-green-600 shadow-sm">
