...
<body class="flex h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
    ...
    <aside class="w-72 bg-white shadow-2xl relative">
        ...
        <div class="flex-1 overflow-y-auto p-6 space-y-3">
            ...
            <a>{{ route('customer.packages.index') }}</a>
            ...
            <a href="{{ route('customer.search') }}"
                class="nav-link {{ request()->routeIs('customer.search') ? 'active bg-gradient-to-r from-blue-50 to-indigo-50 text-indigo-700' : 'text-gray-700 hover:text-indigo-700' }} flex items-center px-4 py-3 rounded-xl hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 transition-all duration-300">
