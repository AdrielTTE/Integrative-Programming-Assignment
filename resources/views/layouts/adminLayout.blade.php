    ...
    <aside class="w-72 bg-white shadow-2xl flex flex-col h-full">
        ...
        <div class="flex-1 overflow-y-auto p-6 space-y-3">
            ...
            <a href="{{ route('admin.refunds.index') }}"
                class="nav-link {{ request()->routeIs('admin.refunds.index') ? 'active bg-gradient-to-r from-blue-50 to-indigo-50 text-indigo-700' : 'text-gray-700 hover:text-indigo-700' }} flex items-center px-4 py-3 rounded-xl hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 transition-all duration-300">
                <i class="fas fa-star w-5 mr-3"></i>
                <span class="font-medium">Refunds</span>
            </a>
            <a href="{{ route('admin.payment.index') }}"
                class="nav-link {{ request()->routeIs('admin.payment.index') ? 'active bg-gradient-to-r from-blue-50 to-indigo-50 text-indigo-700' : 'text-gray-700 hover:text-indigo-700' }} flex items-center px-4 py-3 rounded-xl hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 transition-all duration-300">
                <i class="fas fa-star w-5 mr-3"></i>
