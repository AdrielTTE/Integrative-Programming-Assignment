    ...
    <aside class="w-72 bg-white shadow-2xl flex flex-col h-full">
        ...
        <div class="gradient-bg p-6 text-white relative overflow-hidden">
            ...
            <div class="relative z-10">
                ...
                <p class="text-blue-100 text-sm">Delivery Management System</p>
            </div>
        </div>
        ...
        <div class="flex-1 overflow-y-auto p-6 space-y-3">
            ...
            <a href="{{ route('driver.packages.index') }}"
                class="nav-link {{ request()->routeIs('driver.packages.index') ? 'active bg-gradient-to-r from-blue-50 to-indigo-50 text-indigo-700' : 'text-gray-700 hover:text-indigo-700' }} flex items-center px-4 py-3 rounded-xl hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 transition-all duration-300">
                <i class="fas fa-box w-5 mr-3"></i>
                <span class="font-medium">My Assigned Packages</span>
            </a>-->
            
            <a href="{{ route('driver.status.index') }}"
                class="nav-link {{ request()->routeIs('driver.status.index') ? 'active bg-gradient-to-r from-blue-50 to-indigo-50 text-indigo-700' : 'text-gray-700 hover:text-indigo-700' }} flex items-center px-4 py-3 rounded-xl hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 transition-all duration-300">
                <i class="fas fa-truck w-5 mr-3"></i>
                <span class="font-medium">My Assigned Packages</span>
            </a>
            <a href="{{ route('driver.history.index') }}"
                class="nav-link {{ request()->routeIs('driver.history.index') ? 'active bg-gradient-to-r from-blue-50 to-indigo-50 text-indigo-700' : 'text-gray-700 hover:text-indigo-700' }} flex items-center px-4 py-3 rounded-xl hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 transition-all duration-300">
